...
class MyCounter extends Counter
{
     ...
     * @return null
     */
    private function processHit($page, $id = null)
    {
        $addHit = true;
        ...
        if ($addHit) {
            self::createCountIfNotPresent($page, $id);
        }
    }
    /**
     ...
     * @return null
     */
    private static function createCountIfNotPresent($page, $id = null)
    {
        ...
        $page_record->visitors()->sync([$visitor_record->id => ['created_at' => Carbon::now(), 'specialist_id' => $id]], false);
    }
    /**
